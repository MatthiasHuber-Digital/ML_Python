...
PATH_LOAD_FROM_DISK = None
PATH_SAVE_TO_DISK = (
    "/home/matthias/workspace/Coding/00_vista_medizina/vista_bone_frac/efficientnet_b4_MURA_"
)
...
num_classes = len(ds_train.classes)  # Number of classes based on the directory structure
