...
from utils.general import labels_to_class_weights, labels_to_image_weights, init_seeds, \
    fitness, strip_optimizer, check_img_size, one_cycle, colorstr
...
def train(hyp, opt, device, tb_writer=None):
    ...
    data_dict['train'] = str(Path(data_dict['train']).absolute().resolve())
    data_dict['test'] = str(Path(data_dict['test']).absolute().resolve())
    data_dict['val'] = str(Path(data_dict['val']).absolute().resolve())
    # ======================== 
