...
def train(hyp, opt, device, tb_writer=None):
    ...
    if rank in [-1, 0]:
        ...
        if not opt.resume:
            ...
            # c = torch.tensor(labels[:, 0].astype(np.float64))  # classes
            # c = c.int()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="/home/matthias/workspace/Coding/20_helmet_reco/trained_hhreco_nopad_customytpics_model_20250209/weights/best.pt",
    ...
    parser.add_argument(
        "--data",
        type=str,
        default="/home/matthias/workspace/Coding/20_helmet_reco/data_mixed_wpsafety_yt_20250210/data.yaml",
        help="data.yaml path",
    )
    parser.add_argument(
    ...
    parser.add_argument("--epochs", type=int, default=40)  # default=30)
