...
def kick_off_training(opt: dict):
    # Set DDP variables
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="yolo_v7/yolov7_training.pt",
        help="initial weights path",
    )  #'MachineLearning_Python/yolo_v7/yolov7_training.pt', help='initial weights path')
    parser.add_argument("--cfg", type=str, default="", help="model.yaml path")
    # parser.add_argument('--data', type=str, default='data/coco.yaml', help='data.yaml path')
    parser.add_argument(

        
        "--data", type=str, default="/home/matthias/workspace/Coding/00_vista_medizina/bone_frac_obj_det/00_data/2024-11-14/reclass_single_bodypart/data_forearm_fracture.yaml" #./yolo_v7/ds_bone_frac/2024-11-08/data.yaml", help="data.yaml path"
    )
    parser.add_argument(
        "--hyp",
        type=str,
        default="./yolo_v7/data/hyp_bone_frac.yaml", #"./yolo_v7/data/hyp.scratch.p5.yaml",
