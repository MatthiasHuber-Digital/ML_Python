...
def tensor2img(tensor, ax=plt):
    ...
    # Ensure the CAM has 3 channels for RGB compatibility
    if img.ndim == 2:  # Single-channel (grayscale)
        img = np.stack([img] * 3, axis=-1)  # Repeat the grayscale image across 3 channels
...
path_test_dataset = "/home/matthias/workspace/Coding/00_vista_medizina/00_data/2024-11-22_vista_test/test_set_selected/selected"
...
model = load_efficient_net_model(
    path_model="/home/matthias/workspace/Coding/00_vista_medizina/10_weights/efficient_net/2024-12-09_bf_kaggle_2cl_85pctval/efficientnet-b4_fold3_epoch30_SCHED.pth",
...
for path_image in tqdm(image_paths):
